...
export default function createSend(headers: Record<string, string>, f: any): any {
    ...
    return Function(
        'h', 'i', 'f',
        `return (b,t)=>{if(typeof t==='undefined')return new Response(${body},i);const{headers}=t;if(typeof headers==='undefined')t.headers=h;${propAssigns.join(';')};return new Response(${body},t)}`
    )(headers, { headers }, f);
}
